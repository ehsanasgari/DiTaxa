...
def train_stochastic_cpe(sentenses, outfile, num_symbols, frequency_file, min_frequency=2, verbose=False, is_dict=False):
    """Learn num_symbols BPE operations from vocabulary, and write to outfile.
    """
    outfile = codecs.open(outfile, 'w', 'utf-8')
    f = codecs.open(frequency_file, 'w', 'utf-8')
...
def train_cpe_once(sentenses, min_frequency=2, verbose=False, is_dict=False):
    """Learn num_symbols BPE operations from vocabulary, and write to outfile.
    """
    num_symbols=1
    ...
    return vocab, stats, '{0} {1}'.format(*most_frequent)
